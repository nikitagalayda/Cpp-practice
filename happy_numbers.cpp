/*
A class which will find whether or not a number is happy. A number is happy if: 
...
Time Complexity: O(k), where k is the number of loops we run through in order to reach
